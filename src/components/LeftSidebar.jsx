...
function LeftSidebar() {
  ...
  return (
    <aside className="hidden lg:flex sticky top-24 h-[calc(100vh-6rem)] flex-col w-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden shadow-sm">
          ...
          return (
            <Link
              ...
              className={`
                ...
                ${active
                  ? "bg-gray-100 dark:bg-gray-800 text-orange-500 font-semibold shadow-sm"
