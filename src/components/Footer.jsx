...
import {
    FaApple, FaGooglePlay, FaHeart, FaArrowUp, FaEnvelope,
    FaGraduationCap, FaRocket, FaChartLine, FaUsers, FaCalendar,
    FaGlobeAmericas, FaCodeBranch, FaStar, FaCrown, FaCheckCircle, FaBolt
} from 'react-icons/fa'
import {
    RiTwitterXFill,
    RiFacebookFill,
...
const Footer = () => {
    ...
    const socialMedia = [
        ...
        },
        {
            ...
            hover: 'hover:shadow-purple-500/40 hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-orange-400',
            textColor: 'text-gray-800',
            hoverTextColor: 'text-white'
        },
        {
    ...
    const footerLinks = [
        {
            title: 'Platform',
            icon: <FaRocket className="text-purple-500 group-hover:rotate-12 transition-transform duration-500" />,
            links: [
                { text: 'Campus Connect', tag: 'Popular' },
                { text: 'Study Hub', icon: <FaUsers className="text-xs ml-1 text-blue-500 group-hover:scale-125 transition-transform duration-300" /> },
                { text: 'Career Portal', icon: <FaChartLine className="text-xs ml-1 text-green-500 group-hover:scale-125 transition-transform duration-300" /> },
                { text: 'Event Calendar', icon: <FaCalendar className="text-xs ml-1 text-orange-500 group-hover:scale-125 transition-transform duration-300" /> }
            ]
        },
        {
            title: 'Resources',
            icon: <FaCodeBranch className="text-blue-500 group-hover:rotate-180 transition-transform duration-700" />,
            links: [
                { text: 'API Docs', tag: 'Pro' },
                { text: 'Tutorials' },
                { text: 'Community Forum', icon: <FaGlobeAmericas className="text-xs ml-1 text-cyan-500 group-hover:scale-125 transition-transform duration-300" /> },
                { text: 'Help Center' }
            ]
        },
        {
            title: 'Company',
            icon: <FaCrown className="text-amber-500 group-hover:scale-110 transition-transform duration-500" />,
            links: [
                { text: 'About Us', tag: 'New' },
                { text: 'Careers', tag: 'Hiring' },
                { text: 'Blog' },
                { text: 'Partners', icon: <FaStar className="text-xs ml-1 text-yellow-500 group-hover:scale-125 transition-transform duration-300" /> }
            ]
        }
    ]

    return (
        <footer className="relative bg-gradient-to-br from-gray-50 via-white to-purple-50 border-t border-gray-200/70 pt-6 pb-4 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    ...
                    <div className="flex items-center gap-2 group cursor-pointer">
                        <div className="relative">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 group-hover:shadow-xl">
                                <FaGraduationCap size={18} className="group-hover:scale-110 transition-transform duration-300" />
                            </div>
                            ...
                            {socialMedia.map((social, index) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className={`relative z-10 transition-all duration-300 ${hoveredIcon === index ? social.hoverTextColor : social.textColor}`}>
                                            {social.icon}
                                        </div>
                                        
                                        {/* Background on Hover */}
                                        <div className={`absolute inset-0 rounded-lg ${social.color} opacity-0 ${hoveredIcon === index ? 'opacity-100' : 'opacity-0'} transition-all duration-300`}></div>
                                    </a>

                                    {/* Tooltip with Animation */}
                                    {hoveredIcon === index && (
                                        <div className="absolute -top-7 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded whitespace-nowrap animate-bounceIn z-20">
                                            {social.name}
                    ...
                    <div className="flex gap-1.5">
                        <a href="#" className="px-2 py-1.5 bg-black text-white rounded-lg hover:bg-gray-800 transition-all duration-300 flex items-center gap-1.5 group hover:scale-105 hover:shadow-lg active:scale-95">
                            <FaApple className="text-sm group-hover:scale-110 group-hover:rotate-12 transition-transform duration-500" />
                            <div className="text-left">
                                <div className="text-[7px] group-hover:tracking-wider transition-all duration-300">App Store</div>
                            </div>
                        </a>
                        <a href="#" className="px-2 py-1.5 bg-black text-white rounded-lg hover:bg-gray-800 transition-all duration-300 flex items-center gap-1.5 group hover:scale-105 hover:shadow-lg active:scale-95">
                            <FaGooglePlay className="text-sm group-hover:scale-110 group-hover:-rotate-12 transition-transform duration-500" />
                            <div className="text-left">
                                <div className="text-[7px] group-hover:tracking-wider transition-all duration-300">Play Store</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                    ...
                    <div
                        className="bg-white/50 backdrop-blur-sm rounded-lg p-4 border border-gray-200/50 hover:border-purple-300/50 hover:bg-white/70 hover:shadow-lg transition-all duration-500 group cursor-pointer"
                        onMouseEnter={() => setHoveredLink('description')}
                        onMouseLeave={() => setHoveredLink(null)}
                    >
                        <div className="flex items-center gap-2 mb-2">
                            <div className={`w-6 h-6 rounded-full bg-gradient-to-r from-purple-100 to-pink-100 flex items-center justify-center transition-all duration-500 group-hover:from-purple-200 group-hover:to-pink-200 ${hoveredLink === 'description' ? 'animate-pulse' : ''}`}>
                                <FaBolt className="text-purple-600 group-hover:text-purple-700 group-hover:scale-110 transition-all duration-300" size={12} />
                            </div>
                        ...
                        <p className="text-xs text-gray-600 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                            The ultimate platform connecting students worldwide with AI-powered tools.
                        </p>
                        {/* Hover Indicator */}
                    ...
                    <div className="lg:col-span-2">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            {footerLinks.map((section, sectionIndex) => (
                                <div
                                    key={section.title}
                                    className="bg-white/50 backdrop-blur-sm rounded-lg p-4 border border-gray-200/50 hover:border-purple-200 hover:bg-white/70 hover:shadow-lg transition-all duration-500 group"
                                >
                                    <div className="flex items-center gap-2 mb-3 group-hover:gap-3 transition-all duration-500">
                                        {section.icon}
                                            ...
                                            <li key={link.text}>
                                                ...
                                                >
                                                    <div className="flex items-center gap-1.5">
                                                        <div className={`w-1 h-1 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 opacity-0 group-hover/link:opacity-100 transition-all duration-300 ${hoveredLink === `${sectionIndex}-${linkIndex}` ? 'animate-pulse' : ''}`}></div>
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        {link.tag && (
                                                            <span className={`text-[9px] px-1.5 py-0.5 rounded-full text-white group-hover/link:scale-110 transition-transform duration-300 ${link.tag === 'Popular' ? 'bg-gradient-to-r from-purple-500 to-pink-500 group-hover/link:from-purple-600 group-hover/link:to-pink-600' :
                                                                    link.tag === 'Pro' ? 'bg-gradient-to-r from-amber-500 to-orange-500 group-hover/link:from-amber-600 group-hover/link:to-orange-600' :
                                                                        link.tag === 'New' ? 'bg-gradient-to-r from-green-500 to-emerald-500 group-hover/link:from-green-600 group-hover/link:to-emerald-600' :
                ...
                <div className="relative mb-4 group/newsletter">
                    ...
                    <div className="relative bg-gradient-to-r from-white to-purple-50/30 border border-purple-100 rounded-lg p-4 shadow-sm group-hover/newsletter:shadow-lg group-hover/newsletter:border-purple-300 transition-all duration-500">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                            <div className="flex items-center gap-2 group/icon">
                                <div className="relative">
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white shadow-md group-hover/icon:shadow-lg group-hover/icon:scale-110 transition-all duration-500">
                                        <FaEnvelope size={14} className="group-hover/icon:scale-110 transition-transform duration-300" />
                                    </div>
                                    {/* Pulsing Effect */}
                            ...
                            {subscribed ? (
                                ...
                                <form onSubmit={handleSubscribe} className="flex gap-2 w-full sm:w-auto group/form">
                                    <div className="relative flex-1 sm:w-48">
                                        <input
                                            ...
                                            className="w-full px-3 py-2 text-sm bg-white border border-gray-300 rounded-lg focus:border-purple-500 focus:ring-2 focus:ring-purple-500/30 outline-none transition-all duration-300 group-hover/form:border-purple-400"
                                        />
                                        {/* Focus/Hover Effect */}
                                    ...
                                    <button
                                        type="submit"
                                        className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 text-sm font-medium relative overflow-hidden group/btn"
                                    >
                                        {/* Button Hover Effect */}
                ...
                <div className="border-t border-gray-200/50 pt-4 group/bottom">
            ...
            <style jsx>{`
                ...
                @keyframes bounceIn {
                    ...
                    70% { opacity: 1; transform: translate(-50%, 5px) scale(1.1); }
