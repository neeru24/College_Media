  ...
  const testimonials = [
    {
      ...
      image: "https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDI1LTA2L3Jhd3BpeGVsb2ZmaWNlN19waG90b19vZl95b3VuZ19pbmRpYW5fYm95X2hvbGRpbmdfc3R1ZGVudF9iYWNrcF9mMTgzNzMwYy00ZDdmLTRlNzUtOGE1MC1iZmFkNTI5MjMyYjFfMS5qcGc.jpgw=600&h=600&fit=crop&crop=face"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-black text-white text-center">
        ...
        <Link
          to="/home"
          className="inline-flex gap-2 px-8 py-3 bg-white text-black rounded-full font-medium"
        >
